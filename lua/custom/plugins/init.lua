...
return {{
    ...
    keys = {{
        "<leader>aw",
        "<Plug>WordMotion_aw",
        desc = "Camel case motion[a]"
    }, {
        "<leader>iw",
        "<Plug>WordMotion_iw",
        desc = "Camel case motion[i]"
    }}
}, {
...
-- },
{
    ...
    keys = {{"<leader>rn", "<cmd>Lspsaga rename<cr>", "[R]e[n]ame"},
...
-- },
{
    ...
    lazy = true,
    keys = {{"w", "<cmd>lua require('spider').motion('w')<CR>", {
        desc = "Spider-w"
